			...
			if("0000".equals(paramMap.get("resultCode"))){
				...
				try{
				  ...
				  //throw new Exception("강제 Exception");
					...
					int i = purchaseMapper.paymentInsert(vo);
					if(i > 0) {
						/// 결제완료
						purchaseMapper.purchaseStatusUpdate(vo.getPurchaseNum());
					}
					// 구매번호
					AuthInfoVO authInfo = purchaseMapper.selectMember(resultMap.get("MOID")); 
